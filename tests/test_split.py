...
class TestSplit(unittest.TestCase):
    ...
    def test_single_condition_data(self):
        ...
        self.assertListEqual([1], list(left_split.data.X.get_column(0).compressed()))
        self.assertListEqual([2], list(right_split.data.X.get_column(0).compressed()))
    ...
    def test_combined_condition_data(self):
        ...
        self.assertListEqual([2, 3], list(conditioned_data.X.get_column(0).compressed()))
